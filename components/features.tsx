...
const Features: React.FC = () => {
  ...
  const buttonStyle: React.CSSProperties = {
    background: isHovered
      ? 'rgba(200, 200, 200, 0.8)' // Couleur plus sombre au survol
    ...
    <section>
      <div className="max-w-6xl mx-auto px-4 sm:px-6 mt-[-1rem]" id="features">
        <div className="py-10 md:py-11">
          ...
          <a
            className="btn font-bold text-center w-full mt-4 mb-4 sm:w-auto sm:mb-0 shadow mx-auto flex justify-center"
