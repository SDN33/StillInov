        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="flex items-center shrink-0 mr-4">
            ...
            <div className="flex items-center ml-2">
              <h1 className="text-lg md:text-xl font-bold text-white">Stillinov</h1>
            </div>
          </div>
          ...
          <nav className="hidden md:flex md:grow">
            <ul className="flex grow justify-end flex-wrap items-center">
              ...
              <li>
                <Link href="/services" className="font-medium text-white hover:text-gray-300 px-5 py-3 flex items-center transition duration-150 ease-in-out">Services</Link>
              </li>
              <li>
