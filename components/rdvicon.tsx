    ...
    <div className="fixed bottom-4 right-4 md:bottom-6 md:right-6">
      <div className="relative">
        <button 
          ...
          className="bg-green-500 p-3 rounded-full shadow-lg text-white hover:bg-green-600 transition-colors"
        ...
        {isHovered && (
          <div className="absolute bottom-14 right-1/2 transform translate-x-1/2 bg-gray-800 text-white text-xs rounded py-1 px-2 shadow-lg whitespace-nowrap">
