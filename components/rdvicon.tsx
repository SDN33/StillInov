  ...
  return (
    <div className="relative">
      ...
      {showScrollTop && (
        <button
          onClick={scrollToTop}
          className="bounce-icon fixed bottom-20 right-4 md:bottom-24 md:right-6 p-3 rounded-full shadow-lg text-white bg-gradient-to-br from-teal-400 to-orange-400 flex items-center justify-center transition-transform duration-300 hover:scale-125 z-30"
      ...
      <button
        ...
        className={`bounce-icon fixed bottom-4 right-4 md:bottom-6 md:right-6 p-3 rounded-full shadow-lg text-white bg-gradient-to-br from-orange-400 via-red-500 to-teal-400 flex items-center justify-center hover:scale-150 transition-transform duration-300 ${isPopupOpen ? 'z-40' : 'z-30'}`}
