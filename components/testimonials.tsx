          ...
          <div className="max-w-sm mx-auto grid gap-8 lg:grid-cols-3 lg:gap-6 items-start lg:max-w-none">
            ...
            <div className="flex flex-col h-full p-6 bg-gray-800 transform transition-transform duration-300 hover:scale-105" data-aos="fade-up">
              ...
              <div className="text-gray-700 font-medium mt-6 pt-5 border-t border-gray-700">
                <cite className="text-gray-200 not-italic">J.F Kitsadi</cite> - <a className="hover:text-gray-200 transition duration-150 ease-in-out" href="#0" style={{ fill: "#485b51" }}>SevenMates</a>
              </div>
            </div>
            ...
            <div className="flex flex-col h-full p-6 bg-gray-800 transform transition-transform duration-300 hover:scale-105" data-aos="fade-up" data-aos-delay="200">
              ...
              <div className="text-gray-700 font-medium mt-6 pt-5 border-t border-gray-700">
                <cite className="text-gray-200 not-italic">Diandra Tchatchouang</cite> - <a className="hover:text-gray-200 transition duration-150 ease-in-out" style={{ fill: "#485b51" }} href="https://open.spotify.com/show/0N3bfIgmeKqztwSshyA4Gz">Podcast "Super Humains"</a>
              </div>
            </div>
            ...
            <div className="container mx-auto px-4">
              ...
              <div className="flex flex-wrap justify-center gap-12">
                <div className="flex flex-col items-center max-w-sm">
                  <div className="icon-wrapper p-4 rounded-full mb-4 hover:bg-green-700 hover:scale-110 transition transform duration-200" style={{ fill: "#485b51" }}>
