        ...
        <div className="py-12 md:py-20 border-t border-gray-800">
          ...
          <div className="max-w-sm mx-auto grid gap-8 lg:grid-cols-3 lg:gap-6 items-start lg:max-w-none">
            ...
            <div className="flex flex-col h-full p-6 bg-gray-800 transform transition-transform duration-300 hover:scale-105" data-aos="fade-up" data-aos-delay="400">
              ...
              <div className="text-gray-700 font-medium mt-6 pt-5 border-t border-gray-700">
                <cite className="text-gray-200 not-italic">Cédric Césarini</cite> - <a className="text-purple-600 hover:text-gray-200 transition duration-150 ease-in-out" href="https://www.facebook.com/bewinebegles">Be Wine Bègles</a>
              </div>
            </div>
          ...
          <div>
            <h3 className='mt-8 mb-3 text-xl text-gray-400 text-center'>
              Chez StillInov,<br /> nous croyons que chaque projet est unique, c'est pourquoi nous offrons des solutions personnalisées adaptées à vos besoins spécifiques.<br />Que vous ayez un petit budget ou de grandes ambitions, nous nous engageons à optimiser chaque aspect de votre projet pour vous offrir le meilleur résultat possible.<br />L'équipe StillInov.
            </h3>
          </div>
